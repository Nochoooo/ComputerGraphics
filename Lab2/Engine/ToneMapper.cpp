...
void ToneMapper::loadShaders()
{
    ...
    if (SUCCEEDED(result))
    {
        result = D3DCompileFromFile(L"Shaders/mappingVS.hlsl", NULL, NULL, "main", "vs_5_0", flags, 0,
                                    &vertexShaderBuffer,
                                    NULL);
        if (SUCCEEDED(result))
        {
    ...
    if (SUCCEEDED(result))
    {
        result = D3DCompileFromFile(L"Shaders/toneMapPS.hlsl", NULL, NULL, "main", "ps_5_0", flags, 0,
                                    &pixelShaderBuffer,
                                    NULL);
        if (SUCCEEDED(result))
        {
