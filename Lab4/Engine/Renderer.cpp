...
{
    instance = this;
    swapChain = device.getSwapChain(window, "Lab4 default swap chain");
...
void Renderer::loadShader()
{
    ...
    shadersInfos.push_back({L"Shaders/Lighting/VertexShader.hlsl", VERTEX_SHADER, "Lab4 cube vertex shader"});
    shadersInfos.push_back({L"Shaders/Lighting/PBRPixelShader.hlsl", PIXEL_SHADER, "Lab4 cube pixel shader"});
    ...
    shadersInfos.clear();
    shadersInfos.push_back({L"Shaders/Skybox/skyboxVS.hlsl", VERTEX_SHADER, "Lab4 skybox vertex shader"});
    shadersInfos.push_back({L"Shaders/Skybox/skyboxPS.hlsl", PIXEL_SHADER, "Lab4 skybox pixel shader"});
